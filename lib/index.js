$(document).ready(function(){
  ...
  $("#create-food").on("click", function(){
    ...
    try { if (foodName === '') throw '';}
    catch(err) { message.innerHTML = "Please enter a valid food name!";}
    try { if (foodCalories === '') throw '';}
    catch(err) { message.innerHTML = "Please enter a valid calorie amount!";}
