...
$(document).ready(function(){
  ...
  $('#calories-header').on('click', function() {
    ...
    // var firstCalValue = $('#foods tr:nth-child(1) td:nth-child(2)').html();
    // var secondCalValue = $('#foods tr:nth-child(2) td:nth-child(2)').html();
    // if (firstCalValue < secondCalValue){
    //   var tableRow = $('#foods tr:nth-child(2)')
    //   firstCalValue.insertBefore(secondCalValue);
    // }
    // return tableBody;
  });
